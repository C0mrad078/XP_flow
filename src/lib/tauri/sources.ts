...
import type { CreateSourceInput, ReconcileSummary, SourceSummary, UpdateSourceInput, VideoSource } from "@/types/media";
import type { UUID } from "@/types/domain";

export const sourcesApi = {
  list: (workspaceId: UUID) => invoke<SourceSummary[]>("list_sources", { workspaceId }),
  create: (workspaceId: UUID, input: CreateSourceInput) => invoke<VideoSource>("create_source", { workspaceId, input }),
